...
our $SCHEMA = [
    ...
    #            COMMAND     LABEL        ICON
	{pipe => ['/home/suraj/.config/openbox/pipemenus/places-menu.sh', 'Disk', 'drive-harddisk']},
	{pipe => ['/home/suraj/.config/openbox/pipemenus/obrecent.sh', 'Recent file', 'notes']},
	{pipe => ['/home/suraj/.config/openbox/pipemenus/date-menu.py', 'Date Time', 'date']},
	{pipe => ['/home/suraj/.config/openbox/pipemenus/sysinfo.py', 'System Info', 'system']},
